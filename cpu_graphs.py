...
def plot_time_vs_devices(filename):
    ...
    plt.title("Time vs Number of Devices (CPU)")
    plt.legend()
    plt.grid()
    plt.savefig("time_vs_devices_cpu.png")
    plt.show()
...
def plot_throughput_vs_devices(filename):
    ...
    plt.title("Throughput vs Number of Devices (CPU)")
    plt.legend()
    plt.grid()
    plt.savefig("throughput_vs_devices_cpu.png")
    plt.show()
